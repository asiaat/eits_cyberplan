...
from app.api.v2 import bp_evidences, evidence_upload, protection_mode, modeling, imr_snapshots, dashboard
...
api_router.include_router(dashboard.router, tags=["v2-dashboard"])